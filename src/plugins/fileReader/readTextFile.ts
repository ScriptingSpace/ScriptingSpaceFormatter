import type { FormatterFile, FormatterFileKind } from '../../functions';
...
// Used by the file-reader plugin (plugins/fileReader/FileReaderPlugin.ts) —
// every dropped file lands in the sidebar and renders by kind when selected.
